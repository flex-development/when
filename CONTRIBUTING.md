...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/when
   cd when
   ```
...
```sh
https://github.com/flex-development/when/compare/main...$branch
```
...
[qa]: https://github.com/flex-development/when/discussions/new?category=q-a
